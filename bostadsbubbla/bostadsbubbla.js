...
(function () {
	...
	var dataArray = [
		...
		['2016', 0.9, 4.7, 1.0, 4.4, 6.3, 0.0, 3.9, 6.0, 1.8, 4.7, 5.4, 7.5, 5.3],
		['2017', 1.8, 3.3, 1.7, 5.9, 9.8, -2.2, 3.0, 7.9, 1.4, 4.5, 2.4, 4.6, 2.9],
		['2018', 1.1, 3.6, 1.4, 7.4, 8.3, -1.7, -0.6, 8.9, 2.5, 5.0, 1.0, -3.2, 3.4]
	];
